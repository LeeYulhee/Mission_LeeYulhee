        ...
        if (instaMember != null) {
            ...
            switch (sortCode) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    likeablePeopleStream = likeablePeopleStream.sorted(Comparator.comparing((LikeablePerson e) -> e.getFromInstaMember().getToLikeablePeople().size(), Comparator.reverseOrder()).thenComparing(LikeablePerson::getCreateDate, Comparator.reverseOrder()));
                    break;
                case 4:
                    likeablePeopleStream = likeablePeopleStream.sorted(Comparator.comparing((LikeablePerson e) -> e.getFromInstaMember().getToLikeablePeople().size()).thenComparing(LikeablePerson::getCreateDate, Comparator.reverseOrder()));
                    break;
                case 5:
                    likeablePeopleStream = likeablePeopleStream.sorted(Comparator.comparing((LikeablePerson e) -> e.getFromInstaMember().getGender(), Comparator.reverseOrder()).thenComparing(LikeablePerson::getCreateDate, Comparator.reverseOrder()));
                    break;
                case 6:
                    likeablePeopleStream = likeablePeopleStream.sorted(Comparator.comparing(LikeablePerson::getAttractiveTypeCode).thenComparing(e -> e.getCreateDate(), Comparator.reverseOrder()));
                    break;
            }
